...
from backend.detection.models import DetectionAlert, DetectionResult, ModelMetadata
...
class TestAnomalyScorer:
    def test_score_single_normal_returns_none_or_alert(
    ...
    def test_score_single_alert_has_required_fields(
        self, trained_scorer: AnomalyScorer
    ) -> None:
    ...
    def test_score_single_score_in_range(
        self, trained_scorer: AnomalyScorer
    ) -> None:
    ...
    def test_score_batch_empty_entity_dim(
        self, trained_scorer: AnomalyScorer
    ) -> None:
    ...
    def test_score_batch_alert_count_consistent(
        self, trained_scorer: AnomalyScorer
    ) -> None:
    ...
    def test_score_stream_yields_only_alerts(
        self, trained_scorer: AnomalyScorer
    ) -> None:
    ...
    def test_score_stream_filters_wrong_entity_dim(
        self, trained_scorer: AnomalyScorer
    ) -> None:
    ...
    def test_score_batch_with_errors_still_completes(
        self, trained_scorer: AnomalyScorer
    ) -> None:
